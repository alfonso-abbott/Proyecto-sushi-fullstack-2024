...
import { CarritoContext } from '../context/CarritoContext'; // Importar el contexto
...
const Menu = () => {
  ...
  const handleAgregarAlCarrito = (plato) => {
    agregarAlCarrito(plato); // Agrega el plato al carrito a través del contexto
    setModalMessage(`${plato.nombre}`); // Configura el mensaje del modal
